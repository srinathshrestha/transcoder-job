...
functions.cloudEvent('transcodeOnUpload', async (cloudEvent) => {
  ...
  config: {
    elementaryStreams: [
      // 360p Video Stream Configuration
      {
        ...
        videoStream: {
          h264: {
            ...
            bitrateBps: 400000,
            frameRate: 30,
            gopDuration: { seconds: 6 }, // Align GOP with segment duration
            gopMode: 'FIXED', // Fixed GOP ensures clean segments
            profile: 'high',
            preset: 'veryfast',
            rateControlMode: 'vbr',
            crfLevel: 21,
      ...
      // Stereo Audio Stream Configuration
      {
        key: 'audio_stream',
        audioStream: {
          codec: 'aac',
          bitrateBps: 192000, // High-quality stereo audio
          channelCount: 2, // Stereo
          channelLayout: ['fl', 'fr'], // Front-left and front-right
          sampleRateHertz: 48000, // Standard high-quality audio
        },
      },
    ],
    muxStreams: [
      // HLS Stream for 360p
      {
        ...
        fileName: 'segment_360p_%04d.ts',
        segmentSettings: {
          segmentDuration: { seconds: 6 }, // Segment every 6 seconds
          individualSegments: true, // Ensure separate files for each segment
        },
      },
      // HLS Stream for 720p
      {
      ...
      // HLS Stream for 1080p
      {
        ...
        fileName: 'segment_1080p_%04d.ts',
        segmentSettings: {
          segmentDuration: { seconds: 6 }, // Segment every 6 seconds
          individualSegments: true,
        },
